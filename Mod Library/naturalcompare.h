 ...
 * naturalcompare.h
 * ----------------
 * Purpose: Implementation of a natural string comparison algorithm.
 * Notes  : (currently none)
 * Authors: http://kdeblog.mageprojects.com/2014/07/06/natural-string-sorting-an-in-depth-analysis/
...
static int naturalCompare(const QString &_a, const QString &_b, Qt::CaseSensitivity caseSensitivity)
{
