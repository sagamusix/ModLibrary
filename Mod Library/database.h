...
protected:
	...
	QSqlDatabase db;
	QSqlQuery insertQuery, updateQuery, updateCustomQuery, selectQuery, fpQuery, removeQuery;
...
public:
	...
	bool UpdateCustom(const QString &path, const QString &artist, const QString &comments);
